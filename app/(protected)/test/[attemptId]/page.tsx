...
export default function TestPage() {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            ...
            if (data?.qa_json) {
                const qs = data.qa_json.map((q: any) => q.question);
                setQuestions(qs);
            ...
            <div className="w-full max-w-4xl flex flex-col flex-1">
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 text-sm">Question {current + 1} of {questions.length}</p>
                            </div>
                        </div>
                ...
                <main className="flex-1 flex flex-col gap-8 animate-fade-in">
                    <div className="glass rounded-3xl p-8 md:p-12 shadow-2xl shadow-indigo-500/5 relative overflow-hidden">
                        ...
                        <h3 className="text-xl md:text-2xl font-medium text-slate-100 leading-relaxed mb-8">
                            {questions[current]}
                        </h3>
