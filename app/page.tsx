    ...
    <div className="flex flex-col flex-1 items-center justify-center relative overflow-hidden">
      ...
      <main className="flex flex-col items-center justify-center w-full max-w-5xl px-6 py-24 text-center z-10">
        ...
        <p className="max-w-2xl text-lg md:text-xl text-slate-400 mb-10 leading-relaxed">
          Generate custom assessments, track your conceptual progress, and
          receive AI-driven feedback to accelerate your learning journey.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full text-left">
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm">
            ...
            <h3 className="text-white font-semibold mb-2">
              10-Question Precision
            </h3>
            <p className="text-sm text-slate-400 leading-relaxed">
              Curated assessments designed to test the depth of your
              understanding in exactly 10 questions.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Get comprehensive scores, strength mapping, and a custom
              improvement plan for every attempt.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm">
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              Every attempt is saved. Monitor your growth across different
              topics and difficulty levels.
            </p>
          </div>

          <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-sm hover:bg-white/[0.05] transition-all group">
            <div className="w-10 h-10 rounded-lg bg-amber-500/20 flex items-center justify-center text-amber-400 mb-4 group-hover:scale-110 transition-transform">
              <Trophy size={20} />
            </div>
            ...
            <p className="text-sm text-slate-400 leading-relaxed">
              See how you stack up against the community. Top performers get
              recognized across all technical topics.
            </p>
          </div>
        </div>
      </main>
